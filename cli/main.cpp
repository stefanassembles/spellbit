...
int main(int argc, char *argv[]) {
  ...
  std::cout << "Total: " << duration << " ms , MB/sec : " << mb_per_sec << ", days per Terrabyte: " << days_per_terrabyte << "\n";
  std::cout << "Merging ... ";
  ...
  std::cout << "Total: " << duration << " ms, ms / 1000 tokens : " << time_per_1000_tokens << "\n";
  std::cout << "Final tokens: " << tokens << "\n";
